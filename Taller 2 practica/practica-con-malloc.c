...
int main()
{
    // No puedo desreferenciar algo que no esta inicializado, esto cuando hablamos de puntero, da error "segmentaiton fault"
    // siempre debo iniciar un puntero antes deiniciarlo
